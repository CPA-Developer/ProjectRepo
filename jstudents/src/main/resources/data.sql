...
(   NULL, '08/17/2021', (SELECT WORKER_ID FROM WORKER WHERE FIRST_NAME='Abishek')),
(   NULL, '03/28/2021', (SELECT WORKER_ID FROM WORKER WHERE FIRST_NAME='Colin')),
(   NULL, '12/17/2021', (SELECT WORKER_ID FROM WORKER WHERE FIRST_NAME='Subin')),
(   NULL, '05/21/2021', (SELECT WORKER_ID FROM WORKER WHERE FIRST_NAME='Linse')),
(   NULL, '08/28/2021', (SELECT WORKER_ID FROM WORKER WHERE FIRST_NAME='Dhruv'));
